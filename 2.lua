...
local isTouchEnabled = true -- Simulate as if on mobile device

NotifyLib.prompt('Mobile Device Simulation', 'Running the script as if on a mobile device.', 5)
...
-- Commenting out the line that places the tool into the player's backpack
-- tool.Parent = game:GetService("Players").LocalPlayer:WaitForChild("Backpack")
local player = game:GetService("Players").LocalPlayer
player.CharacterRemoving:Connect(function()
    -- Removing the tool from the player's backpack upon character removal
